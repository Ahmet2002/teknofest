...
class MyDroneHandler(DroneHandler):
    ...
    def user(self):
        ...
        print("WPNAV_SPEED SET : ", str(self.set_param(param="WPNAV_SPEED", value_real=50.0)).upper())
        print("WPNAV_SPEED_UP SET : ", str(self.set_param(param="WPNAV_SPEED_UP", value_real=50.0)).upper())
        print("WPNAV_SPEED_DN SET : ", str(self.set_param(param="WPNAV_SPEED_DN", value_real=50.0)).upper())
        print("WPNAV_RADIUS SET : ", str(self.set_param(param="WPNAV_RADIUS", value_real=15.0)).upper())
