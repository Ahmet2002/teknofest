...
datas = {
		...
		"E" : { "list" : [Waypoint(z=-3.0, is_open=True), Waypoint(x=1.5, is_open=True), Waypoint(z=1.5), Waypoint(x=-1.5, is_open=True), Waypoint(z=1.5), Waypoint(x=1.5, is_open=True)],
			"width" : 2.25},
		"K" : { "list" : [Waypoint(z=-3.0, is_open=True), Waypoint(2.0), Waypoint(x=-1.5, z=1.5, is_open=True), Waypoint(x=1.5, z=1.5, is_open=True)],
			"width" : 2.25},
		"N" : { "list" : [Waypoint(z=-3.0, is_open=True), Waypoint(z=3.0), Waypoint(x=2.0 ,z=-3.0, is_open=True), Waypoint(z=3.0, is_open=True)],
			"width" : 2.75},
